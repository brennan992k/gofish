...
public class Myscore : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        if (previousScore != Score) //save perf from non needed calculations
        {
            if (Score < 10 && Score >= 0)
            {
                transform.position = new Vector3(myfirstPos - 1.3f, transform.position.y, 0);
            ...
            {
                transform.position = new Vector3(myfirstPos - 1.1f, transform.position.y, 0);
            ...
            {
                transform.position = new Vector3(myfirstPos - 0.9f, transform.position.y, 0);
            ...
            {
                transform.position = new Vector3(myfirstPos - 0.7f, transform.position.y, 0);
